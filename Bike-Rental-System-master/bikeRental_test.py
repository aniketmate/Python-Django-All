...
class BikeRentalTest(unittest.TestCase):
    ...
    def test_Bike_Rental_diplays_correct_stock(self):
        ...
        shop1 = BikeRental()    
        shop2 = BikeRental(10)
        self.assertEqual(shop1.displaystock(), 0)                           # We have currently 0 bikes available to rent.
        self.assertEqual(shop2.displaystock(), 10)                          # We have currently 10 bikes available to rent.
                                                                            # Sorry! We have currently 10 bikes available to rent.
    def test_rentBikeOnHourlyBasis_for_negative_number_of_bikes(self):
        shop = BikeRental(10)
        self.assertEqual(shop.rentBikeOnHourlyBasis(-1), None)

    def test_rentBikeOnHourlyBasis_for_zero_number_of_bikes(self):              # Number of bikes should be positive!
        shop = BikeRental(10)
    ...
    def test_rentBikeOnHourlyBasis_for_valid_positive_number_of_bikes(self):
        ...
        self.assertEqual(shop.rentBikeOnHourlyBasis(2).hour, hour)             # You have rented 2 bike(s) on daily basis today at 23 hours.
    ...
    def test_returnBike_for_invalid_rentalTime(self):
        ...
        self.assertIsNone(shop.returnBike(request))                         #Are you sure you rented a bike with us?
    ...
    def test_returnBike_for_invalid_rentalBasis(self):
        ...
        # create valid rentalTime and bikes                           Thanks for returning your bike. Hope you enjoyed our service!      
